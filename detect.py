...
def parse_opt():
    ...
    parser.add_argument('--weights', nargs='+', type=str, default= r'runs\exp30\weights\best.pt', help='model path(s)')
    parser.add_argument('--source', type=str, default=r'D:\Detections\train2\test', help='file/dir/URL/glob, 0 for webcam')
    ...
    parser.add_argument('--project', default=ROOT / 'D:/Detections/tests/runs1', help='save results to project/name')
